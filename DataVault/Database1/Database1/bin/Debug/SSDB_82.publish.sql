...
GO
PRINT N'Der Umgestaltungsvorgang mit Umbenennung mit Schlüssel "36a06fc7-518b-41bd-bb61-1710ac4f7afd, 6655a62c-7315-44eb-ba70-ff32f2e91436" wird übersprungen; das Element "[hub].[Spot_Leuchte].[Effizienzklasse]" (SqlSimpleColumn) wird nicht in "Image" umbenannt.';


GO
PRINT N'Der Umgestaltungsvorgang mit Umbenennung mit Schlüssel "f900d9c8-c05e-4c71-92f0-b54b44fca364" wird übersprungen; das Element "[sat].[Spot_Leuchte_Stammdaten].[Website]" (SqlSimpleColumn) wird nicht in "SEO_Url" umbenannt.';
...
CREATE TABLE [hub].[Spot_Leuchte] (
    ...
    [Lichtstrom]     DECIMAL (18)   NOT NULL
);
