...
CREATE TABLE [sat].[Spot_Leuchte_Stammdaten] (
    ...
    [Nettogewicht]        DECIMAL (5, 2) NOT NULL,
    [Außendurchmesser]    INT            NOT NULL,
    [Hoehe]               INT            NOT NULL,
    [Moegliche_Konverter] VARCHAR (MAX)  NOT NULL,
    [Offline]             VARCHAR (50)   NOT NULL,
