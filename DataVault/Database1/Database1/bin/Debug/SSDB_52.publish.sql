...
GO
ALTER TABLE [sat].[Spot_Leuchte_Stammdaten] ALTER COLUMN [Website] VARCHAR (MAX) NULL;
...
GO
PRINT N'Prozedur "[dbo].[load_sat_Spot_Leuchte_Stammdaten]" wird aktualisiert...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[load_sat_Spot_Leuchte_Stammdaten]';
