...
GO
/*
Der Typ von Spalte "Maße" in Tabelle "[sat].[Spot_Gehaeuse_Stammdaten]" lautet aktuell " NVARCHAR (50) NOT NULL", wird aber in " VARCHAR (50) NOT NULL" geändert. Es kann zu einem Datenverlust kommen, und möglicherweise ist die Bereitstellung nicht erfolgreich, wenn die Spalte Daten enthält, die nicht mit dem Typ " VARCHAR (50) NOT NULL" kompatibel sind.
*/
...
GO
ALTER TABLE [sat].[Spot_Gehaeuse_Stammdaten] ALTER COLUMN [Maße] VARCHAR (50) NOT NULL;
