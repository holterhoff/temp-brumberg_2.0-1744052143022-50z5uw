...
GO
PRINT N'Tabelle "[hub].[M1_Gehaeuse]" wird erstellt...';
...
CREATE TABLE [hub].[M1_Gehaeuse] (
    ...
    [Montageart_2]    NVARCHAR (50) NOT NULL,
    [Montageart_3]    NVARCHAR (50) NOT NULL,
    [Verstellbarkeit] NVARCHAR (50) NOT NULL,
...
GO
PRINT N'Tabelle "[link].[Spot_Gehaeuse__Leuchte]" wird erstellt...';


GO
CREATE TABLE [link].[Spot_Gehaeuse__Leuchte] (
...
GO
PRINT N'Tabelle "[sat].[M1_Gehaeuse_Artikel]" wird erstellt...';


GO
CREATE TABLE [sat].[M1_Gehaeuse_Artikel] (
    [Gehaeuse_SK]   INT            NOT NULL,
...
GO
PRINT N'Tabelle "[sat].[M1_Gehaeuse_Stammdaten]" wird erstellt...';


GO
CREATE TABLE [sat].[M1_Gehaeuse_Stammdaten] (
    [Gehaeuse_SK]         INT           NOT NULL,
    [Masse]               NVARCHAR (50) NOT NULL,
    [Einbaudurchmesser]   NVARCHAR (50) NOT NULL,
    [Einbautiefe]         NVARCHAR (50) NOT NULL,
    [Hoehe]               NVARCHAR (50) NOT NULL,
    [Schwenkwinkel]       NVARCHAR (50) NOT NULL,
    [Anzahl_Leuchtmittel] NVARCHAR (50) NOT NULL,
