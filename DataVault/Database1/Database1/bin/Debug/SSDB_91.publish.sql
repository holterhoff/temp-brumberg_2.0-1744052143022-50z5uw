...
GO
PRINT N'Der Umgestaltungsvorgang mit Umbenennung mit Schlüssel "4081b2fa-bd86-456d-84a9-1b6143178ba7" wird übersprungen; das Element "[sat].[Spot_Treiber_Stammdaten].[Website]" (SqlSimpleColumn) wird nicht in "SEO_Url" umbenannt.';
