...
GO
ALTER TABLE [sat].[Spot_Treiber_Stammdaten] ALTER COLUMN [Image] VARCHAR (100) NOT NULL;
...
GO
PRINT N'Prozedur "[dbo].[load_sat_Spot_Treiber_Stammdaten]" wird aktualisiert...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[load_sat_Spot_Treiber_Stammdaten]';
