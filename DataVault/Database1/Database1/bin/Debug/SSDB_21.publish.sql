...
GO
/*
Der Typ von Spalte "Leistung" in Tabelle "[hub].[Spot_Leuchte]" lautet aktuell " DECIMAL (5, 5) NOT NULL", wird aber in " DECIMAL (2, 5) NOT NULL" geändert. Es kann zu einem Datenverlust kommen, und möglicherweise ist die Bereitstellung nicht erfolgreich, wenn die Spalte Daten enthält, die nicht mit dem Typ " DECIMAL (2, 5) NOT NULL" kompatibel sind.
*/
