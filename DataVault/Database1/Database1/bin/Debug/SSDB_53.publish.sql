...
GO
ALTER TABLE [sat].[M1_Leuchte_Stammdaten]
    ADD [Website] VARCHAR (MAX) NULL;


GO
PRINT N'Tabelle "[hub].[M1_Treiber]" wird erstellt...';


GO
CREATE TABLE [hub].[M1_Treiber] (
    ...
    CONSTRAINT [PK_hub_M1_Treiber] PRIMARY KEY CLUSTERED ([Treiber_SK] ASC)
);


GO
PRINT N'Tabelle "[link].[M1_Gehaeuse__Leuchte]" wird erstellt...';


GO
CREATE TABLE [link].[M1_Gehaeuse__Leuchte] (
...
GO
PRINT N'Tabelle "[link].[M1_Leuchte__Treiber]" wird erstellt...';


GO
CREATE TABLE [link].[M1_Leuchte__Treiber] (
    [Leuchte_SK] INT NOT NULL,
