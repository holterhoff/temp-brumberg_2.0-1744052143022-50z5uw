...
GO
/*
Der Typ von Spalte "Leistung" in Tabelle "[hub].[Spot_Leuchte]" lautet aktuell " DECIMAL (18, 5) NOT NULL", wird aber in " DECIMAL (18, 2) NOT NULL" geändert. Es kann zu einem Datenverlust kommen, und möglicherweise ist die Bereitstellung nicht erfolgreich, wenn die Spalte Daten enthält, die nicht mit dem Typ " DECIMAL (18, 2) NOT NULL" kompatibel sind.
*/
...
CREATE TABLE [hub].[tmp_ms_xx_Spot_Leuchte] (
    ...
    [Leistung]        DECIMAL (18, 2) NOT NULL,
