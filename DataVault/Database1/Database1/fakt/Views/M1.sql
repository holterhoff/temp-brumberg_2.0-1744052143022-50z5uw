...
CREATE VIEW [fakt].[M1] as 

SELECT 

		CONCAT(h1.Gehaeuse_SK, '-', h2.Leuchte_SK, '-', h3.Treiber_SK) as ID
	,	h1.Leuchtentyp
	,	h1.Typ_DE as Typ_Gehaeuse_DE
	,	h1.Typ_EN as Typ_Gehaeuse_EN
	,	CONCAT(h1.Leuchtentyp, ' ', h1.Form_DE, ' ', Farbe_DE, ' ',h1.Typ_DE) as Bezeichnung_DE
	,	CONCAT(h1.Leuchtentyp, ' ', h1.Form_EN, ' ', Farbe_EN, ' ',h1.Typ_DE) as Bezeichnung_EN
	,	CONCAT(h1.Typ_DE, ' - ', h1.Montageart_2_DE) as Typ_DE
	,	CONCAT(h1.Typ_EN, ' - ', h1.Montageart_2_EN) as Typ_EN
	,	h1.Form_DE
	,	h1.Form_EN
	,	h1.Farbe_DE
	,	h1.Farbe_EN
	,	CONCAT(h1.Montageart_3_DE, ' - ', h1.Verstellbarkeit_DE) as Verstellbarkeit_DE
	,	CONCAT(h1.Montageart_3_EN, ' - ', h1.Verstellbarkeit_EN) as Verstellbarkeit_EN
	,	s1.Schutzart
	...
	,	CONCAT(h1.Leuchtentyp, ' ', h1.Form_DE, ' ', h1.Farbe_DE, ' ', h1.Typ_DE) as Bezeichnung_Gehaeuse_DE
	,	CONCAT(h1.Leuchtentyp, ' ', h1.Form_EN, ' ', h1.Farbe_EN, ' ', h1.Typ_EN) as Bezeichnung_Gehaeuse_EN
 ...
 INNER JOIN link.M1_LED__Treiber l2 ON l2.Leuchte_SK = h2.Leuchte_SK AND l2.Gehaeuse_SK = h1.Gehaeuse_SK
