...
export default async function getVerstellbarkeit(req, res) {
  if (req.method == 'POST') {
    let params = JSON.parse(req.body)

    let query = 'SELECT DISTINCT verstellbarkeit_de as value_de, verstellbarkeit_en as value_en FROM m1  WHERE 1=1 '
