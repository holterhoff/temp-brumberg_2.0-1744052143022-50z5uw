// ** To use core palette, uncomment the below import
 ...
 const UserThemeOptions = () => {
   ...
   return {
     ...
     typography: {
       //  fontFamily: '"sans-serif", "Corporate S"'
       ...
       fontFamily:
         '"Montserrat", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Corporate S" '
     },
     shadows:
       mode === 'light'
         ? [
