...
const AnsteuerungOptions = props => {
  ...
  return (
    <Fragment>
      ...
      >
        <Grid item xs={12}>
          {/* Box-Container für maximale Breite und responsives Verhalten */}
...
export default AnsteuerungOptions
