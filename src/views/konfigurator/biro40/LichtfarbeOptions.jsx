...
const LichtfarbeOptions = props => {
  ...
  return (
    <Fragment>
      ...
      >
        <Grid item xs={12}>
          {/* Box-Container sorgt für maximale Breite und responsives Verhalten */}
...
export default LichtfarbeOptions
